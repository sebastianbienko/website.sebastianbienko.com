...
export const PreviousWorkData = [
  ...
  },
  {
    ...
    description: [
      "For many, the journey to their dream kitchen begins online. Nolte Küchen seamlessly guides users from their online kitchen plan to the nearest dealership.",
      'Early in my career, I had the opportunity to take on the dual role of tech lead and project manager. While challenging, this role provided ample opportunities for growth. We successfully integrated a kitchen planner into the user journey on the website and implemented various engagement mechanisms to assist users in taking the next step.',
    ],
  },
];
